    ...
    <nav class="navbar navbar-expand-lg navbar-dark sticky-top">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="https://via.placeholder.com/150x50?text=شعار+الوزارة" alt="شعار الوزارة">
                منصة تراخيص البناء
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                            ...
                            <div class="mega-menu-content">
                                <div class="mega-menu-column">
                                    ...
                                    <ul class="mega-menu-list">
                                        <li class="nav-item"><a  href="#" class=" ajax-link" data-page="main.Regulations.indexmain">تراخيص البناء السكني <i class="fas fa-home"></i></a></li>
                                        <li class="nav-item"><a  href="#" class=" ajax-link" data-page="main.fee_inquiries">تراخيص التوسعات السكنية <i class="fas fa-expand"></i></a></li>
                                        <li class="nav-item"><a  href="#" class=" ajax-link" data-page="main.fee_inquiries">تراخيص الترميم <i class="fas fa-tools"></i></a></li>
                                        <li class="nav-item"><a  href="#" class=" ajax-link" data-page="main.fee_inquiries">تراخيص الأسوار والحدائق <i class="fas fa-tree"></i></a></li>
                                    </ul>
                                </div>
                        ...
                        <div class="dropdown-menu" aria-labelledby="platformsDropdown">
                            <div class="mega-menu-content">
                                <div class="mega-menu-column">
                                    ...
                                    <ul class="mega-menu-list">
                                        <li><a href="#" class="ajax-link" data-page="main.statistical_report">منصة التراخيص <i class="fas fa-file-contract"></i></a></li>
                                        <li><a href="#" class="ajax-link" data-page="main.statistical_report">منصة الشكاوى <i class="fas fa-comment-dots"></i></a></li>
                                        <li><a href="#" class="ajax-link" data-page="main.statistical_report">منصة الاستشارات <i class="fas fa-headset"></i></a></li>
                                        <li><a href="#" class="ajax-link" data-page="main.statistical_report">منصة التدريب <i class="fas fa-graduation-cap"></i></a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="mega-menu-column">
                                    ...
                                    <ul class="mega-menu-list">
                                        <li><a href="#" class="ajax-link" data-page="main.statistical_report">منصة الدفع الإلكتروني <i class="fas fa-credit-card"></i></a></li>
                                        <li><a href="#" class="ajax-link" data-page="main.statistical_report">منصة الفواتير <i class="fas fa-file-invoice-dollar"></i></a></li>
                                        <li><a href="#" class="ajax-link" data-page="main.statistical_report">منصة التحصيل <i class="fas fa-money-check"></i></a></li>
                                        <li><a href="#" class="ajax-link" data-page="main.statistical_report">منصة المصروفات <i class="fas fa-cash-register"></i></a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="mega-menu-column">
                                    ...
                                    <ul class="mega-menu-list">
                                        <li><a href="#" class="ajax-link" data-page="main.statistical_report">منصة المتابعة الميدانية <i class="fas fa-hard-hat"></i></a></li>
                                        <li><a href="#" class="ajax-link" data-page="main.statistical_report">منصة الجودة <i class="fas fa-clipboard-check"></i></a></li>
                                        <li><a href="#" class="ajax-link" data-page="main.statistical_report">منصة التوثيق <i class="fas fa-folder-open"></i></a></li>
                                        <li><a href="#" class="ajax-link" data-page="main.statistical_report">منصة التقييم <i class="fas fa-star"></i></a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="mega-menu-column">
                                    ...
                                    <ul class="mega-menu-list">
                                        <li><a href="#" class="ajax-link" data-page="main.statistical_report">منصة البيانات المفتوحة <i class="fas fa-database"></i></a></li>
                                        <li><a href="#" class="ajax-link" data-page="main.statistical_report">منصة الإحصاءات <i class="fas fa-chart-bar"></i></a></li>
                                        <li><a href="#" class="ajax-link" data-page="main.statistical_report">منصة المؤشرات <i class="fas fa-chart-line"></i></a></li>
                                        <li><a href="#" class="ajax-link" data-page="main.statistical_report">منصة التقارير <i class="fas fa-file-alt"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="nav-icons-container">
                    ...
                    <li>
                         ...
                         {{-- {{ route('beneficiary.amr')}} --}}
                        <a href=""  class="nav-link ajax-link" data-page="navbar_profile">
                            <div class="nav-icon">
