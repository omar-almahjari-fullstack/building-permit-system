    ...
    <div class="process-controls">
        <div class="request-info" style=" position: fixed; top: 45px; left: 15px; display: flex;">
            ...
            <div style=" display: flex;">
                ...
                <span class="request-number" id="request-number" data-id="{{ $id }}">RQ</span>
            ...
            <div class="content_Amr" dir="ltr">
                <div class="contener_Citizen">
                    ...
                    <div class="search">
                        ...
                        <div class="search_1 row" dir="rtl">
                            ...
                            <div class="input-group col-xl-4 mb-2">
                                <input type="number" class="form-control" placeholder="بحث برقم الهوية"
                    ...
                    <table class="table table-hover table-striped text-right" style="margin-top: 20px;">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="bac">
                                                    ...
                                                    <input type="number" class="form-control" name="mobile"
                                                        id="validationCustom03" required  maxlength="9" oninput="if(this.value.length > 9) this.value = this.value.slice(0,9);" >
                                                </div>
                                            </div>
                        ...
                        <form class="form_request" id="form_request" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="col-md-2 mb-3">
                                    <br>
                                    <button type="button" class="btn btn-primary btn-save-request next-step-btn-request next-step-btn"
                ...
                <div class="contener_requests">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="form_add" id="form_license" enctype="multipart/form-data">
                            ...
                            <button type="button" class="btn btn-primary btn-save-request-number next-step-btn" data-action="save"
                                data-form="#form_license" data-url="add-license_Ajax" data-method="POST"  data-step-target="4">
                                حفظ
                            </button>
                        </form>
