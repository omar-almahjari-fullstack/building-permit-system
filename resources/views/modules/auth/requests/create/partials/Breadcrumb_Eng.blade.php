...
<div class="process-stepper">
    ...
    <div class="process-fill" style="width: 12%;"></div>
    ...
    <div class="process-step completed " data-step="2">
        <div class="step-bubble">
        ...
        <div class="process-step completed active" data-step="3">
                <div class="step-bubble">
    ...
    <div class="process-controls">
        <div class="request-info" style=" position: fixed; top: 45px; left: 15px; display: flex;">
            ...
            <div style=" display: flex;">
                ...
                <span class="request-number" id="request-number" data-id="{{ $id }}">RQ{{ $id }}</span>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="bac">
                                        ...
                                        <input type="tel" step="0.01" class="form-control" name="area"
                                            id="area" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    <div class="bac">
                                        ...
                                        <input type="number" class="form-control" value="1" name="floors_count"
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="bac">
                                        ...
                                        <input type="tel" step="0.01" class="form-control"
                ...
                <div class="contener_requests">
                    <div class="modal-body">
                        ...
                        <form id="landDataForm" class="form_add" style="border: snow solid 1px; margin-bottom: 30px">
                            ...
                            <table class="table table-hover text-right">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row">1</th>
                                        <td><input type="number" class="form-control" name="plot_number"
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    <div class="bac">
                                        ...
                                        <input type="number" step="0.01" class="form-control" name="building_percentage"
                                            required>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="bac">
                                        ...
                                        <input type="number" class="form-control" name="max_height" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    <div class="bac">
                                        ...
                                        <input type="number" class="form-control" name="excavation_depth">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="bac">
                                        <label>كثافة التربة</label>
                                        <input type="number" class="form-control" name="soil_density">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="bac">
                                        ...
                                        <input type="number" class="form-control" name="street_width">
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <div class="bac">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="bac">
                                        ...
                                        <input type="number" class="form-control" name="parking_area">
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table table-hover text-right">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" class="form-control" name="deed_length_n"
                                                value="24">
                                        </td>
                                        <td><input type="number" class="form-control" name="deed_length_e"
                                                value="25.3">
                                        </td>
                                        <td><input type="number" class="form-control" name="deed_length_s"
                                                value="24">
                                        </td>
                                        <td><input type="number" class="form-control" name="deed_length_w"
                                                value="24.85">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" class="form-control" name="nature_length_n"
                                                ></td>
                                        <td><input type="number" class="form-control" name="nature_length_e"
                                                >
                                        </td>
                                        <td><input type="number" class="form-control" name="nature_length_s"
                                                ></td>
                                        <td><input type="number" class="form-control" name="nature_length_w"
                                                >
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" class="form-control" name="angle_n"
                                               ></td>
                                        <td><input type="number" class="form-control" name="angle_e"
                                               ></td>
                                        <td><input type="number" class="form-control" name="angle_s"
                                                ></td>
                                        <td><input type="number" class="form-control" name="angle_w"
                                                ></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" class="form-control" name="setback_n" required>
                                        </td>
                                        <td><input type="number" class="form-control" name="setback_e" required>
                                        </td>
                                        <td><input type="number" class="form-control" name="setback_s" required>
                                        </td>
                                        <td><input type="number" class="form-control" name="setback_w" required>
                                        </td>
                                    </tr>

                                    <tr>
                                        <th scope="row">البروز</th>
                                        <td><input type="number" class="form-control" name="protrusion_n"
                                                required></td>
                                        <td><input type="number" class="form-control" name="protrusion_e"
                                                required></td>
                                        <td><input type="number" class="form-control" name="protrusion_s"
                                                required></td>
                                        <td><input type="number" class="form-control" name="protrusion_w"
                                                required></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" class="form-control" name="street_width_n"
                                                required></td>
                                        <td><input type="number" class="form-control" name="street_width_e"
                                                required></td>
                                        <td><input type="number" class="form-control" name="street_width_s"
                                                required></td>
                                        <td><input type="number" class="form-control" name="street_width_w"
                                                required></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" class="form-control" name="parking_lengths_n"
                                                required></td>
                                        <td><input type="number" class="form-control" name="parking_lengths_e"
                                                required></td>
                                        <td><input type="number" class="form-control" name="parking_lengths_s"
                                                required></td>
                                        <td><input type="number" class="form-control" name="parking_lengths_w"
                                                required></td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <form class="form_add" id="engineer_site_reports">
                            ...
                            <button type="submit" class="btn btn-primary btn-save-request-number next-step-btn"
                                data-action="save" data-form="#engineer_site_reports"
                                data-url="add-engineer_site_reports_Ajax" data-method="POST" data-step-target="3">
        ...
        <div class="step-content active" id="step3">
            ...
            <div class="content">
                 ...
                 <div class="submit-section">
                        ...
                        <p class="text-muted mb-4"> بعد التأكد من صحة قطعة الارض، يمكنك إرسال التقرير المساحي إلى إدارة المراجعة الفنية</p>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <div class="request-number">
                    رقم الطلب: <span class="request-number" data-id="{{ $id }}">RQ{{ $id }}</span>
                </div>
...
<script>
 ...
 /////   حقل الأرقام التحقق من الادخال
  $(document).ready(function () {
    document.querySelectorAll('input[type="number"]').forEach(function (input) {

        // منع كتابة e + - من الكيبورد
        ...
        // منع القيم السالبة + منع الحروف عند اللصق
        input.addEventListener("input", function () {
            // احذف أي شيء غير أرقام
            this.value = this.value.replace(/[^0-9]/g, '');

            // لو القيمة سالبة، رجعها صفر
            if (this.value < 0) {
                this.value = 0;
            }
        });
    ...
    $(document).ready(function() {
        ...
        $('#submitRequestBtn_Report').on('click', function() {
            ...
            // محاكاة لطلب AJAX
            $.ajax({
                url: `/requests/submit_Report_s/${requestId}`,
                method: 'GET',
                success: function() {
                    // عند النجاح، عرض المودال (بدون jQuery .modal)
                    try {
                        if (window.bootstrap && bootstrap.Modal) {
                            const modalEl = document.getElementById('successModal_Report');
