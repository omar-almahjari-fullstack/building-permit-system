        ...
        <div class="login-card">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-3 form-check">
                    ...
                    <label class="form-check-label" for="remember">تذكر بيانات الدخول على هذا الجهاز</label>
                </div>
                ...
                <div class="security-notice">
                    ...
                    <span>يجب التأكد من أنك تستخدم جهازاً آمناً ومعتمداً للوصول إلى النظام الحكومي</span>
                </div>
            </form>
