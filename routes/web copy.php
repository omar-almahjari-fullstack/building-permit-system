...
Route::middleware(['auth:beneficiary'])->group(function () {
   ...
   Route::get('/platform_user', function () {
        return view('platform_user.app'); // تحميل القالب الرئيسي فقط
    });
...
Route::get('/ajax-page/{page}', [PageAjaxController::class, 'loadPage']);
    ...
    Route::get('/platform_user_profile', function () {
    return view('platform_user.navbar_profile'); // تحميل القالب الرئيسي فقط
    })->name('platform_user_profile');

//   Route::get('/ajax-page-platform/{page}',function(){
